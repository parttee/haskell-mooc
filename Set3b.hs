...
mymaximum bigger initial (x:[]) = if initial `bigger` x then initial else x
mymaximum bigger initial (x:xs) = if x `bigger` initial then mymaximum bigger x xs else mymaximum bigger initial xs
